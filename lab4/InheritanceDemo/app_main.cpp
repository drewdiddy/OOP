...
class TextBox: public Shape {
    ...
    float b;
public:
	TextBox() : text("funk"), x(-.8), y(.5), font(GLUT_BITMAP_TIMES_ROMAN_24), r(1), g(1), b(1){}
	TextBox(string text, float x, float y, void* font = GLUT_BITMAP_HELVETICA_18, float r = 1, float g = 1, float b = 1): text(text), x(x), y(y), font(font), r(r), g(g), b(b) {}
...
int main(int argc, char** argv) {
    ...
    shapes.push_back(new TextBox("funky fresh m8", -.9, .7));
